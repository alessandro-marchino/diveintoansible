...
class Inventory(object):
    ...
    # Constructor
    def __init__(self, include_hostvars_in_list, debug_log=False):
    ...
    def configure_logger(self):
        ...
        self.hdlr = logging.FileHandler('/tmp/ansible_dynamic_inventory.log')
...
Inventory(include_hostvars_in_list=True, debug_log=False)
